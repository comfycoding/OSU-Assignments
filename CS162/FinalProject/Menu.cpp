...
/*********************************************************************
 ** Function: clearInput
 ** Description: These are necessary lines when alternating between cin
 ** and the getline methods of receiving input, I found myself using
 ** these frequently so I created a function to save a little space.
 *********************************************************************/
