...
/*********************************************************************
 ** Function: getID
 ** Description: All Critters have an ID so that they can be identified
 ** from the Path class. Generic critters have an ID set to 0.
 *********************************************************************/

int Critter::getID() {
    return 0;           // Critters get ID 0
}

/*********************************************************************
 ** Function: breed
 ** Description: This is a virtual function, but since generic Critters
 ** do not breed they will always return NULL.
 *********************************************************************/

Critter* Critter::breed(int x, int y, int n) {
    return NULL;
}